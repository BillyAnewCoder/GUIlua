...
function DiscordLib:Window(text)
        ...
        TopFrame.BackgroundColor3 = Color3.fromRGB(54, 57, 63)
        ...
        TopFrameHolder.BackgroundColor3 = Color3.fromRGB(54, 57, 63)
        ...
        CloseBtn.BackgroundColor3 = Color3.fromRGB(54, 57, 63)
        ...
        MinimizeBtn.BackgroundColor3 = Color3.fromRGB(54, 57, 63)
        ...
        ServersHoldFrame.BackgroundColor3 = Color3.fromRGB(32, 34, 37)
        ...
        ServersHold.BackgroundColor3 = Color3.fromRGB(32, 34, 37)
        ...
        SettingsFrame.BackgroundColor3 = Color3.fromRGB(54, 57, 63)
        ...
        UserPanel.BackgroundColor3 = Color3.fromRGB(54, 57, 63)
        ...
        UserPanelUserCircle.ImageColor3 = Color3.fromRGB(54, 57, 63)
        ...
        UserPanelUserIcon.MouseButton1Click:Connect(function()
                ...
                UnderBar.BackgroundColor3 = Color3.fromRGB(54, 57, 63)
                ...
                UnderBarFrame.BackgroundColor3 = Color3.fromRGB(54, 57, 63)
        ...
        LeftFrame.BackgroundColor3 = Color3.fromRGB(54, 57, 63)
        ...
        function ServerHold:Server(text, img)
                ...
                Server.BackgroundColor3 = Color3.fromRGB(88, 101, 242)
                ...
                ServerFrame.BackgroundColor3 = Color3.fromRGB(54, 57, 63)
                ...
                ServerFrame1.BackgroundColor3 = Color3.fromRGB(54, 57, 63)
                ...
                ServerFrame2.BackgroundColor3 = Color3.fromRGB(54, 57, 63)
                ...
                ServerTitleFrame.BackgroundColor3 = Color3.fromRGB(54, 57, 63)
                ...
                GlowFrame.BackgroundColor3 = Color3.fromRGB(54, 57, 63)
                ...
                ServerContentFrame.BackgroundColor3 = Color3.fromRGB(54, 57, 63)
                ...
                function ChannelHold:Channel(text)
                        ...
                        ChannelBtn.MouseEnter:Connect(function()
                                ...
                                ChannelBtn.BackgroundColor3 = Color3.fromRGB(66, 70, 77)
                        ...
                        ChannelBtn.MouseButton1Click:Connect(function()
                                ...
                                for i, v in next, ServerChannelHolder:GetChildren() do
                                        if v.ClassName == "TextButton" then
                                                v.BackgroundColor3 = Color3.fromRGB(54, 57, 63)
                        ...
                        if fc == false then
                                ...
                                -- Add Discord-style welcome message matching reference images
                                local WelcomeFrame = Instance.new("Frame")
                                local WelcomeTitle = Instance.new("TextLabel")
                                local WelcomeSubtitle = Instance.new("TextLabel")
                                local WelcomeIcon = Instance.new("Frame")
                                local WelcomeIconCorner = Instance.new("UICorner")
                                local WelcomeIconText = Instance.new("TextLabel")
                                local WelcomeDescription = Instance.new("TextLabel")
                                
                                WelcomeFrame.Name = "WelcomeFrame"
                                WelcomeFrame.Parent = ChannelHolder
                                WelcomeFrame.BackgroundTransparency = 1.000
                                WelcomeFrame.BorderSizePixel = 0
                                WelcomeFrame.Size = UDim2.new(0, 401, 0, 280)
                                
                                WelcomeIcon.Name = "WelcomeIcon"
                                WelcomeIcon.Parent = WelcomeFrame
                                WelcomeIcon.BackgroundColor3 = Color3.fromRGB(88, 101, 242)
                                WelcomeIcon.Position = UDim2.new(0.45, 0, 0.08, 0)
                                WelcomeIcon.Size = UDim2.new(0, 68, 0, 68)
                                
                                WelcomeIconCorner.CornerRadius = UDim.new(1, 0)
                                WelcomeIconCorner.Parent = WelcomeIcon
                                
                                WelcomeIconText.Parent = WelcomeIcon
                                WelcomeIconText.BackgroundTransparency = 1.000
                                WelcomeIconText.Size = UDim2.new(1, 0, 1, 0)
                                WelcomeIconText.Font = Enum.Font.GothamBold
                                WelcomeIconText.Text = "#"
                                WelcomeIconText.TextColor3 = Color3.fromRGB(255, 255, 255)
                                WelcomeIconText.TextSize = 32.000
                                ...
                                WelcomeSubtitle.Position = UDim2.new(0, 0, 0.43, 0)
                                WelcomeSubtitle.Size = UDim2.new(1, 0, 0, 38)
                                ...
                                WelcomeDescription.Position = UDim2.new(0, 0, 0.62, 0)
                                WelcomeDescription.Size = UDim2.new(1, 0, 0, 45)
                                WelcomeDescription.Font = Enum.Font.Gotham
                                WelcomeDescription.Text = "This is the start of the #" .. text .. " channel. Here are some things you can do to get started."
                                WelcomeDescription.TextColor3 = Color3.fromRGB(163, 166, 170)
                                WelcomeDescription.TextSize = 14.000
                        ...
                        function ChannelContent:Dropdown(text, list, callback)
                                ...
                                DropdownFrameMain.BackgroundColor3 = Color3.fromRGB(54, 57, 63)
